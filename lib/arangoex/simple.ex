defmodule Arangoex.Simple do
  ...
  def get_first_document_by_example(collection_name, example, headers \\ [], opts \\ []) do
    {:ok, body} = JSON.encode(%{collection: collection_name, example: example})

    "first-example"
      |> build_url(opts) |> Arangoex.put(body, headers, opts)
  end

  # PUT /_api/simple/any
  # Return a random document from the collection identified by collection-name.
  def get_random_document(collection_name, headers \\ [], opts \\ []) do
  ...
  def list_documents(collection_name, headers \\ [], opts \\ []) do
  ...
  def list_documents_by_example(collection_name, example, headers \\ [], opts \\ []) do
  ...
  def list_documents_for_keys(collection_name, keys \\ [], headers \\ [], opts \\ []) do
  ...
  def remove_documents_by_example(collection_name, example, headers \\ [], opts \\ []) do
  ...
  def remove_documents_for_keys(collection_name, keys \\ [], headers \\ [], opts \\ []) do
  ...
  def replace_documents_by_example(collection_name, example, document, headers \\ [], opts \\ []) do
    # todo - implement limit and waitForSync options
  ...
  def update_documents_by_example(collection_name, example, document, headers \\ [], opts \\ []) do
